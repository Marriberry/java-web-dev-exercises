...
public class Car {
    ...
    public void drive(double miles)
    {
        ...
        System.out.println("The maxDistance is: " + maxDistance);
        ...
        System.out.println("The milesAbleToTravel is: " + milesAbleToTravel);
        double gallonsUsed = milesAbleToTravel / this.milesPerGallon;
        System.out.println("The gallonsUsed is: " + gallonsUsed);
        this.gasTankLevel = this.gasTankLevel - gallonsUsed;
        System.out.println("The gasTankLevel is: " + this.gasTankLevel);
        this.odometer += milesAbleToTravel;
        System.out.println("The odometer is: " + this.getOdometer());
    }
